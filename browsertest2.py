...
textentry=browser.find_element_by_name('ctl00$ContentPlaceHolder$dtgAttendance$ctl03$TxtRemarks').send_keys('Canara Bank VAPT Project')
textentry.click()
time.sleep(5)
